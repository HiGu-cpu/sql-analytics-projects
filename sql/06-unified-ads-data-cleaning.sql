...
create or replace function decode_utm_campaign(url_parameters Text) returns text as $$               
declare utm_val Text;                                                                                
begin - Utm icinden utm_campaign degerini al utm_val := LOWER(SUBSTRING(url_parameters FROM 'utm_camp
-- eğer 'nan' ise NULL yap                                                                           
IF utm_val = 'nan' then RETURN NULL; else                                                            
RETURN utm_val; END IF;                                                                              
END;                                                                                                 
$$ LANGUAGE plpgsql;                                                                                 
...
select ad_date,                                                                                      
decode_utm_campaign(url_parameters) as utm_campaign,                                                 
spend,                                                                                               
impressions,                                                                                         
reach,                                                                                               
clicks,                                                                                              
